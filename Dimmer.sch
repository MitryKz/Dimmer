...
F 2 "Capacitor_SMD:C_0402_1005Metric" H 4650 5050 50  0001 C CNN
...
F 2 "Capacitor_SMD:C_0805_2012Metric" H 3600 5050 50  0001 C CNN
...
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x04_P2.54mm_Horizontal" H 9050 4600 50  0001 C CNN
...
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x04_P2.54mm_Horizontal" H 9200 3300 50  0001 C CNN
...
U 1 1 60F08572
P 2270 4790
F 0 "#PWR0119" H 2270 4640 50  0001 C CNN
F 1 "+3.3V" H 2285 4963 50  0000 C CNN
F 2 "" H 2270 4790 50  0001 C CNN
F 3 "" H 2270 4790 50  0001 C CNN
	1    2270 4790
	1    0    0    -1  
$EndComp
$Comp
...
F 3 "~" H 600 3250 50  0001 C CNN
	...
	-1   0    0    1   
$EndComp
Text GLabel 2270 4890 0    50   Input ~ 0
Load_cntrl
$Comp
L power:GND #PWR0120
U 1 1 60F02207
P 2270 5190
F 0 "#PWR0120" H 2270 4940 50  0001 C CNN
F 1 "GND" H 2275 5017 50  0000 C CNN
...
F 2 "Capacitor_SMD:C_0402_1005Metric" H 1750 2950 50  0001 C CNN
...
U 1 1 60FAFA99
P 8850 5800
F 0 "TH2" H 8948 5846 50  0000 L CNN
F 1 "Thermistor_NTC" H 8948 5755 50  0000 L CNN
F 2 "Resistor_SMD:R_1206_3216Metric_Pad1.30x1.75mm_HandSolder" H 8850 5850 50  0001 C CNN
...
U 1 1 60F827BC
P 8850 5350
F 0 "R13" H 8920 5396 50  0000 L CNN
...
F 2 "OptoDevice:R_LDR_5.1x4.3mm_P3.4mm_Vertical" V 9350 5650 50  0001 L CNN
...
F 2 "LED_THT:LED_D3.0mm_Clear" H 9850 5550 50  0001 C CNN
...
F 2 "LED_THT:LED_D3.0mm_Clear" H 10250 5550 50  0001 C CNN
...
U 1 1 60F8C200
P 2470 4990
F 0 "J4" H 2550 5032 50  0000 L CNN
F 1 "Conn_01x05" H 2550 4941 50  0000 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x05_P2.54mm_Vertical" H 2470 4990 50  0001 C CNN
F 3 "~" H 2470 4990 50  0001 C CNN
	1    2470 4990
	1    0    0    -1  
$EndComp
Text GLabel 6100 1350 2    50   Input ~ 0
Detect_null
Text GLabel 2270 5090 0    50   Input ~ 0
Detect_null
Wire Wire Line
	1350 4900 1350 4990
Connection ~ 1350 4990
Wire Wire Line
	1350 4990 1350 5100
Wire Wire Line
	1350 4990 2270 4990
...
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x03_P2.54mm_Vertical_SMD_Pin1Right" H 9055 4225 50  0001 C CNN
